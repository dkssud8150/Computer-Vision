...
faceProto="opencv_face_detector.pbtxt" # 얼굴을 감지하기 위한 파일, txt 형식
...
while cv2.waitKey(1)<0: # waitkey(0)키를 누를 때까지 창을 무한대로 효시(이미지 표시에 적합), waitkey(1)는 1ms동안 프레임을 표시한 후 디스플레이가 자동으로 닫힘
